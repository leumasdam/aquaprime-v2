...
related: vybrat-skrinku-pod-akvarium, udrzba-stabilita-akvaria, aquascaping-rastliny
faq:
  - q: Aká veľkosť akvária je vhodná pre začiatočníka?
    a: Rozumný začiatok je nádrž s objemom približne 100–200 l. Väčší objem drží stabilnejšiu chémiu vody než malá nádrž, takže sa chyby v starostlivosti neprejavia tak rýchlo a prudko.
  - q: Ako dlho trvá zábeh nového akvária?
    a: Nitrifikačný cyklus, teda vybudovanie kolónie baktérií vo filtri a substráte, trvá spravidla približne 2–4 týždne. Ryby sa nasadzujú až po jeho skončení.
  - q: Môžem do nového akvária nasadiť ryby hneď po napustení?
...
- **Filter** — mechanická a biologická filtrácia, srdce celého systému.
- **Ohrievač s termostatom** — pri tropických rybách udržiava stabilnú teplotu vody.
- **Osvetlenie** — pre rastliny aj pre prirodzený vzhľad nádrže.
- **Substrát** — piesok, štrk alebo špeciálny substrát pre rastliny.
- **Poklop alebo kryt** — obmedzuje odparovanie a chráni ryby pred vyskočením.
- **Teplomer a testovacie súpravy** — na meranie pH, tvrdosti vody a hodnôt amoniaku, dusitanov a dusičnanov.
- **Vedro, hadica a prípravok na úpravu vodovodnej vody** — na výmeny vody.
...
3. **Umyte nádrž a rozmiestnite substrát.** Piesok alebo štrk prepláchnite čistou vodou bez chemických prípravkov.
4. **Napustite vodu a nainštalujte techniku.** Filter, ohrievač aj osvetlenie zapojte podľa pokynov výrobcu.
5. **Spustite zábeh bez rýb.** Filter a substrát potrebujú čas na vybudovanie baktérií.
...
- **Nasadenie rýb bez dokončeného cyklu.** Amoniak a dusitany v novej nádrži rybám škodia.
- **Priveľmi dôkladné čistenie filtra.** Prepláchnutím vodou z vodovodu, ktorá obsahuje chlór, zničíte kolóniu užitočných baktérií.
- **Náhla výmena veľkého množstva vody alebo skoková zmena teploty.** Ryby to zaťaží viac než postupné, menšie zmeny.
...
|---|---|---|
| Akvárium (float sklo, 8 mm) | 100 × 40 × 50 cm, 200 l | 143,90 € |
