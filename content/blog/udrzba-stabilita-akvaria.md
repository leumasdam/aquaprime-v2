...
related: prve-akvarium-zacinajuci, umiestnenie-akvaria-v-byte, aquascaping-rastliny
faq:
...
|---|---|---|
| Výmena vody 20 – 30 % | 1× týždenne | 20 – 30 |
| Stieranie skla zvnútra | 1× týždenne | 5 – 10 |
| Odstránenie zvyškov krmiva a detritu | 1× týždenne | 5 |
| Kontrola teploty a chodu filtra | priebežne | 1 – 2 |
| Test vody (NH3, NO2, NO3, pH) | týždenne pri novom akváriu, mesačne pri stabilnom | 5 – 10 |
| Preplach mechanickej náplne filtra | 1× za 2 – 4 týždne | 15 – 20 |
...
- **Mechanická náplň** (špongia, vata) — preplachuje sa častejšie, približne raz za 2 – 4 týždne, len na uvoľnenie zachytených nečistôt.
- **Biologická náplň** (keramické krúžky, biologické guľôčky) — takmer sa jej nedotýkajte; nanajvýš ju jemne opláchnite raz za niekoľko mesiacov, a to vždy len jednu časť pri jednej údržbe.
...
| Amoniak (NH3) | 0 mg/l |
| Dusitany (NO2) | 0 mg/l |
| Dusičnany (NO3) | približne do 25 – 40 mg/l |
| Teplota | približne 24 – 26 °C |
| pH | podľa druhu rýb, spravidla mierne kyslé až neutrálne |

Amoniak a dusitany by v zabehnutom akváriu mali byť trvalo na nule — akýkoľvek merateľný nárast signalizuje problém (prekrmovanie, príliš dôkladné čistenie filtra, preplnenie nádrže rybami). Dusičnany sa naopak tvoria priebežne a ich rast medzi výmenami vody je normálny, len nemá prekročiť rozumnú hranicu.
