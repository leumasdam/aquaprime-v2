 ...
 */
export default function Drobcek({ cesta, jazyk = "sk" }: {
  /** medzikroky bez domova; posledný je aktuálna stránka */
  cesta: { nazov: string; href?: string }[];
  /** jazyk stránky — určuje text aj cieľ odkazu domov */
  jazyk?: Jazyk;
}) {
  return (
    <nav className="drobcek" aria-label={SLOVNIKY[jazyk].spolocne.drobcekAria}>
      <Link href={odkaz("/", jazyk)} className="drobcek__domov" transitionTypes={["nav-dozadu"]}>
